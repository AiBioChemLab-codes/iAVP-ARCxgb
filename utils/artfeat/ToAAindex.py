...
def toAAindex_emb(seq_pd):
    ...
    for seq in track(SEQ_,"AAindex computing..."):
        seqaaidx=seq2AAIndexMat(seq)
         
        aaindex_feature=pd.concat([aaindex_feature,seqaaidx],axis=0, ignore_index =True)
     
     
    aaindex_feature=pd.concat([seq_pd,aaindex_feature],axis=1,ignore_index=True)
